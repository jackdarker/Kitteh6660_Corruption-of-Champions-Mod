...
package classes.Scenes.Areas.Lake 
{
	...
	public class FenrisGooFight extends GooGirl
	{
		...
		override public function teased(lustDelta:Number):void
		{
			...
			else outputText("\nIt appears the goo-girl has gotten lost in her mimicry, squeezing her breasts and jilling her shiny " + this.skin.tone + " clit, her desire to investigate you forgotten.");
		...
		{
			clearOutput();
			outputText("Todo: Fenris and you have your way with her.");
			player.orgasm();
			player.slimeFeed();
			game.combat.cleanupAfterCombat();
		}
